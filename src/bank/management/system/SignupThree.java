...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        accountype.setBounds(100,140,200,30);
        add(accountype);
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-4184"); //dummy number
        number.setFont(new Font("Raleway", Font.BOLD, 22));
        number.setBounds(330,300,300,30);
        add(number);
        
        JLabel carddetail = new JLabel("You 16-Digit Card Number");
        ...
        JLabel pnumber = new JLabel("XXXX"); //dummy number
        pnumber.setFont(new Font("Raleway", Font.BOLD, 22));
        pnumber.setBounds(330,370,300,30);
        add(pnumber);
        
        JLabel pindetail = new JLabel("Your 4-Digit PIN"); //dummy number
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            Random random = new Random(); //6/12- 28.27
